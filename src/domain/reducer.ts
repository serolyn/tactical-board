...
import { findUnitType } from './catalog'
import {
  MAX_GRID_SIZE,
  MIN_GRID_SIZE,
...
/**
 * Pure scenario reducer. It never mutates its inputs and never reads time or randomness.
 * Invalid commands throw a DomainError and leave the supplied document untouched.
 */
...
/** Compatibility helper for callers that only need the next document. */
