...
export interface Faction {
  ...
  /** Stable semantic role; unlike the label, it is not changed by renaming the faction. */
...
/** A durable copy: editing or archiving the source type never changes placed units. */
...
/** Persisted shape used before objectives, continuity and scenario lifecycle were introduced. */
...
/** @deprecated Kept as a source-compatible alias for the original public API. */
...
export interface CommandBase {
  /** When omitted, updatedAt is kept unchanged so applying a command stays deterministic. */
