...
export type { ImageAssetRecord } from '@/tactical-board/persistence/imageAssetRecord'
...
export async function inspectImageBlob(
  ...
  const dimensions =
    mimeType === 'image/svg+xml'
      ...
      : (() => {
          // Les images sont limitées à 5 Mio avant d'atteindre cette fonction.
...
/** Ramène une image validée à 512 px maximum et à un format raster sûr. */
...
/** Construit l’enregistrement persistant après validation et normalisation complètes. */
