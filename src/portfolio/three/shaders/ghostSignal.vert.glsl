...
void main() {
  ...
  // A closed cylinder becomes an asymmetric, tapered and twisted spectral shard.
  // The deformation keeps real front, back and side faces, unlike the former plane.
  ...
  // Pointer and early scroll alter the internal fold as well as the outer rig.
