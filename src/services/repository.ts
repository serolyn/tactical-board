...
/**
 * Converts persisted V1 documents without dropping any existing field. The
 * repository deliberately performs this conversion inside the same IndexedDB
 * transaction as the read so consumers never observe a half-migrated library.
 */
